...
3. STRUCTURE:
   - Hook: Compelling opening that grabs attention (30 seconds)
   - Introduction: What the episode is about, why it matters (1-2 minutes)
   - Main Content: Break down the information into digestible segments with natural transitions
   - Callbacks: Reference earlier points naturally
   - Conclusion: Key takeaways and final thoughts
4. PACING: Include natural pauses [PAUSE], transitions, and segment breaks
5. AUTHENTICITY: Make the narrator sound like they're reporting based on findings
6. CITATIONS: Naturally mention sources when referencing specific information
